$path = "$env:TEMP\myfile.log";
$y = 50;
Out-File -FilePath $path -InputObject "Started!"
for ( $l = 0; $l -lt $y; $l = $l + 1 ) {
    $string = "ENTRY: $l of $y"
    Out-File -FilePath $path -InputObject $string -Append;
    sleep 1;
}

# Set-AuthenticodeSignature "$env:USERPROFILE\OneDrive - weatherlights.com\Documents\Developing\CCM\Skripts\SimplePowershellService\Service.ps1" @(Get-ChildItem cert:\CurrentUser\My -codesigning)[0] -TimestampServer http://time.certum.pl
# SIG # Begin signature block
# MIIk+QYJKoZIhvcNAQcCoIIk6jCCJOYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUznVCxkky3PGCjlHjO2E9mBsk
# CKOggh4pMIIFCTCCA/GgAwIBAgIQDapMmE8NUKJDb44cpXT3cDANBgkqhkiG9w0B
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU24SJHGfC5Ymdd11xWbR0PaSV
# iNswDQYJKoZIhvcNAQEBBQAEggEAJtM/feB2eZ2NY82PVvt8WSAH6my2TTIt3/kh
# L5IDLll+bIfEbjy3/euIibfEUDqYrvw5TntTex1QevjkaulJtwYIw9VBSUXrJWYl
# k3DwRYIVHvSydNrlRdVCmRNdOJv65tTcUklHusYzWYX9hzCAGIIkevWgCN17dQkk
# fkjp4y65+ljGhjZe9zaBAGvQnh+F5h7x6aPjaQLM/RHde6gpz1faNLjgqcO56781
# EuI3M8UmjyzFW/zxO2OthpM7ZDoM4lblWpUn15esP4PTRZdER5CDBfIvWsvJokUe
# Kle1neCf+V9SlHDwDZuF2Z2IABCRgO7ZW+/eCECaEYCfjeKCgqGCBAQwggQABgkq
...
# MjEwNjIzMjAwNjA3WjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCAbWb/o5XcrrPZD
# u3mstI6BWHhPIcVUrhNHbToaPgXF0zA/BgkqhkiG9w0BCQQxMgQwqwFzs85TqJnr
# t5j+SS3SOE/aUNlsLQP7V8zrFkNlv+91xneIQmnUraTX0Mz0Ze0WMIGgBgsqhkiG
...
# 4nviDjJgjkv0qDANBgkqhkiG9w0BAQEFAASCAgBE52gAjqmucpN3qSqv+3o9Ffzz
# Qvb1mkOBKCSebdLAMI8sOvs8prpSCry9qJRMgMxVFmFpw+wqXWgKLyBSbcF3MBB4
# ChPXL7E8qC7uv2/SL5pROj0tyOlBw44VC00P2axJrqBjqMHSjJpiEAjX9Z/7UYIE
# 9g6azzos7Qgier2IPttAe1cVFvjSYShNhEdZNDzkudMw9Jw4eDAXfCeheQm2lsQp
# icgMKp0k/kqtAHOJzan6CakqNsWgk8tTh+PqWvRVtfiV+dH3rJegw1z9PnLqytHW
# Zxo9b3zmmM65u2/8Z+kuAGIfFOD7O/i+aB30nJM8DKTyx2F6fqN8tg18tGFezhxa
# 9D0zNIwBM0AtKdwmxPweqOb4mxBPH7sHt+FPNox8kyYD1q4aA/uPU47FFpUx9jUm
# Y+Y1aN6bjy+FpywJgh+vS6NmWmkSebO4vxAu2e66vIJSwsuxzwIb8Up7QAl0rdD4
# DvPZi9DbXf3BPBtgThZv+7fMZwKOmFhODcpzr/EkJBZSgUsWuDDT3/8LSuXKSfnW
# JEZJPue1KFI/01AGPm53BaDKP5fos52db8f5kxHNeGEFcxUz28EDC0SNhYWaNref
# lTdzWsrlcGoSwHVopm5lVl4jrb+l4RZzBTPUk2sveTCfwIQDH3x81riFw6OIQ1IM
# +iN8WD9d/DIgBgZepQ==
